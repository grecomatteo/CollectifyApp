...
class GradientText extends StatelessWidget {
  ...
  // Helper method to check if colors list is valid
  static void assertColorsValid(List<Color> colors) {
    if (colors.length < 2) {
      throw ArgumentError('Colors list must have at least two colors');
    }
  }
